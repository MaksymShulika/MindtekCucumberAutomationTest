...
//        Assert.assertEquals(data.get(i).get("OTHER LICENSES").toString(), dbData.get(0).get("company_name"));
        ...
        Assert.assertEquals(data.get(i).get("NOTES").toString(), dbData.get(0).get("notes"));
        Assert.assertEquals(data.get(i).get("Contact name").toString(), dbData.get(0).get("employer_id_number"));
        Assert.assertEquals(data.get(i).get("Policy effective day").toString(), dbData.get(0).get("policy_effective_day"));
        Assert.assertEquals(data.get(i).get("Policy expiration").toString(), dbData.get(0).get("policy_expiration"));
        Assert.assertEquals(data.get(i).get("Type of insurance1").toString(), dbData.get(0).get("type_of_insurance"));
        Assert.assertEquals(data.get(i).get("Automobile liability").toString(), dbData.get(0).get("automobile_liability"));
        Assert.assertEquals(data.get(i).get("Numbers of trucks insured").toString(), dbData.get(0).get("num_of_trucks_insured"));
        Assert.assertEquals(data.get(i).get("Policy number").toString(), dbData.get(0).get("policy_number"));
        Assert.assertEquals(data.get(i).get("Billing address (for check)").toString(), dbData.get(0).get("billing_address"));
        Assert.assertEquals(data.get(i).get("Bank name(for ACH payment)").toString(), dbData.get(0).get("bank_name"));
        Assert.assertEquals(data.get(i).get("Routing Number (for ACH payment)").toString(), dbData.get(0).get("routing_number"));
        Assert.assertEquals(data.get(i).get("Account Number(for ACH payment)").toString(), dbData.get(0).get("account_number"));
        Assert.assertEquals(data.get(i).get("President full name").toString(), dbData.get(0).get("president_full_name"));
        Assert.assertEquals(data.get(i).get("Trucks in fleet").toString(), dbData.get(0).get("trucks_in_fleet"));
        Assert.assertEquals(data.get(i).get("SCAC code").toString(), dbData.get(0).get("scac_code"));
        Assert.assertEquals(data.get(i).get("Other licenses").toString(), dbData.get(0).get("other_licenses"));
        Assert.assertEquals(data.get(i).get("Incorporated in").toString(), dbData.get(0).get("incorporated_in"));
        Assert.assertEquals(data.get(i).get("Warning").toString(), dbData.get(0).get("warning"));
